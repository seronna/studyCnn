...
def train_model_process(model, train_dataloader, val_dataloader, num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        for step, (b_x, b_y) in tqdm(enumerate(train_dataloader), desc=f"Training Epoch {epoch}"):
            b_x = b_x.to(device)
            b_y = b_y.to(device)
            model.train()
    ...
    # 选择最优参数，保存最优参数的模型
    torch.save(best_model_wts, "/Users/xiahaike/project/study/python/studyCnn/VGG16/best_model.pth")
